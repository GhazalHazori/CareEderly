...
class CustomEditMidicine extends StatefulWidget {
  const CustomEditMidicine({super.key, this.update, this.delet});

  final Function? update;
  final Function? delet;
  @override
  State<CustomEditMidicine> createState() => _CustomEditMidicineState();
}

class _CustomEditMidicineState extends State<CustomEditMidicine> {
